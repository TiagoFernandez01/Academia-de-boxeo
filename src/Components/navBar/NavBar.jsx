...
function Navbar() {
  ...
  return (
    <nav className="bg-[#101010] dark:bg-gray-900 sticky top-0 z-20 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="" className="h-8" alt="" />
          <span className="self-center text-2xl font-bebas whitespace-nowrap text-white dark:text-white"> <a className='text-red-800'>C</a>olche <a className='text-red-800'>T</a>eam</span>
        </a>
